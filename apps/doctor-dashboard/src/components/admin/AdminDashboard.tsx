...
export const Dashboard: React.FC = () => {
  ...
  const [showModal, setShowModal] = useState<'doctor' | 'asha' | 'hospital' | 'book' | null>(null);
  ...
  return (
    <div className="space-y-6 bg-slate-50 min-h-screen p-2 sm:p-4 text-slate-800 font-sans">
      ...
      {/* --- TAB 1: OVERVIEW (ORIGINAL ANALYTICS & STATS) --- */}
      {activeTab === 'overview' && (
        <>
          {/* Metric Cards Grid */}
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              ...
              <button className="text-xs text-sky-600 font-semibold hover:text-sky-700 hover:underline flex items-center bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">
      ...
      {/* --- TAB 2: PATIENTS & DOCTOR APPOINTMENTS --- */}
      {activeTab === 'patients' && (
        <div className="space-y-6">
          {/* Risk Level Categorization Bar */}
      ...
      {/* --- TAB 3: ADMIN MANAGEMENT (ADD DOCTOR, ASHA, HOSPITAL) --- */}
      ...
      {/* --- MODALS FOR ADMIN ACTIONS & BOOKINGS --- */}
